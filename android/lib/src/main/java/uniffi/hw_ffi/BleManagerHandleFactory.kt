...
suspend fun BleManagerHandle.Companion.new(): BleManagerHandle {
    return uniffiRustCallAsync(
        UniffiLib.uniffi_hw_ffi_fn_constructor_blemanagerhandle_new(),
        { future, callback, continuation ->
            UniffiLib.ffi_hw_ffi_rust_future_poll_u64(future, callback, continuation)
        },
        { future, continuation ->
            UniffiLib.ffi_hw_ffi_rust_future_complete_u64(future, continuation)
        },
        { future ->
            UniffiLib.ffi_hw_ffi_rust_future_free_u64(future)
        },
